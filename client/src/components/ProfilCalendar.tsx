...
function ProfilCalendar({
	...
	return (
		<div className="profile-scheduler">
			...
			<div className="profile-scheduler-header">
				<button
					type="button"
			...
			<div className="profile-scheduler-grid">
				{days.map((day) => (
					<div key={day.fullDate} className="profile-day-column">
